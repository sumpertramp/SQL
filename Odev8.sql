...
--3)
--1. Güncelleme
UPDATE employee SET name = 'PATİKA'
WHERE id=8; --Güncellendi.
SELECT*FROM employee; --Güncelleme kontrol edildi.
--2. Güncelleme
UPDATE employee SET birthday = '1992-12-10'
WHERE id=19; --Güncellendi.
SELECT * FROM employee; --Güncelleme kontrol edildi.
--3. Güncelleme
UPDATE employee
SET name = 'sumeyyederelli'
WHERE name = 'PATİKA';--Güncellendi.
SELECT * FROM employee; --Güncelleme kontrol edildi.
--4. Güncelleme
UPDATE employee
SET email = 'smyydrll@gmail.com'
WHERE id < 20; --Güncellendi.
SELECT * FROM employee; --Güncelleme kontrol edildi.
--5. Güncelleme
UPDATE employee
SET name = 'Sumeyye'
WHERE email LIKE 'k%'; --Güncellendi.
SELECT * FROM employee; --Güncelleme kontrol edildi.

--4)
--1. Silme
DELETE FROM employee
WHERE name = 'Sumeyye'; --Silindi.
SELECT * FROM employee; --Silme işleminden sonra kontrol edildi.
--2. Silme
DELETE FROM employee
WHERE email LIKE '%u'; --Silindi. 
SELECT * FROM employee; --Silme işleminden sonra kontrol edildi.
--3. Silme
DELETE FROM employee
WHERE name LIKE 'K%'; --Silindi. 
SELECT * FROM employee; --Silme işleminden sonra kontrol edildi.
--4. Silme
DELETE FROM employee
WHERE id IN(1,2,8,18,40); --Silindi. 
SELECT * FROM employee; --Silme işleminden sonra kontrol edildi. 
--5. Silme
DELETE FROM employee
WHERE id BETWEEN 10 AND 20; --Silindi. 
SELECT*FROM employee; --Silme işleminden sonra kontrol edildi.  
